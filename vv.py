...
def main():
    ...
    if opt == '3':
        return opt
    if opt == '4':
        os.system(f'xdg-open https://www.facebook.com/YOUR.DADY.HAMIM')
        return opt
    if opt == '5':
        os.system('https://www.facebook.com/YOUR.DADY.HAMIM');time.sleep(1)
        return opt
    if opt == '6':
        os.system(f'https://www.facebook.com/YOUR.DADY.HAMIM')
        os.system('Exit')
        return None
...
\033[0;93m██    ██    ███████      █████  ██ ███████ ██   ██ ██   ████ 
\033[1;91m╔════════════════════════════════════════╗
\033[1;32m║\033[1;32m[•] Author    \033[1;32m : HAMIM UDDIN JISAN                 \033[1;32m      
