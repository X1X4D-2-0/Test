...
for t in range(10000)
    aa='Mozilla/5.0 (Linux; Android 10; V2099A Build/QP1A.190711.020; wv'
    b=random.choice(['7.0','8.1.0','9','10','11','12'])
    c=random.choice(['Android 10; V2099A Build/QP1A.190711.020; wv'])
    ...
    l='Chrome/83.0.4103.106 Mobile Safari/537.36'
