...
def dynamic(text):
    ...
    for o in titik:
        ...
        header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 12; Nokia C12 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.61 Mobile Safari/537.36"}
...
for ua in range(500):
    ...
    c='Nokia C12 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
